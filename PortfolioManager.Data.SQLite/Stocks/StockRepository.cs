...
namespace PortfolioManager.Data.SQLite.Stocks
{
    public class SQLiteStockRepository : SQLiteEffectiveDatedRepository<Stock>, IStockRepository
    {
        ...
        protected override SQLiteCommand GetAddRecordCommand()
        {
            ...
            {
                _GetAddRecordCommand = new SQLiteCommand("INSERT INTO Stocks ([Id], [FromDate], [ToDate], [ASXCode], [Name], [Type], [Parent]) VALUES (@Id, @FromDate, @ToDate, @ASXCode, @Name, @Type, @Parent)", _Connection);
        ...
        protected override SQLiteCommand GetUpdateRecordCommand()
        {
            ...
            {
                _GetUpdateRecordCommand = new SQLiteCommand("UPDATE Stocks SET [ToDate] = @ToDate, [ASXCode] = @ASXCode, [Name] = @Name, [Type] = @Type, [Parent] = @Parent WHERE [Id] = @Id AND [FromDate] = @FromDate", _Connection);
