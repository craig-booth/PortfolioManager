...
namespace PortfolioManager.Domain.CorporateActions.Events
{
    public class DividendAddedEvent : CorporateActionAddedEvent
    {
        ...
        public DividendAddedEvent(Guid entityId, int version, Guid actionId, DateTime actionDate, string description, DateTime paymentDate, decimal dividendAmount, decimal percentFranked, decimal drpPrice)
