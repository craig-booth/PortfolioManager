...
namespace PortfolioManager.Service.CorporateActions
{
    ...
    class CorporateActionHandlerFactory : ICorporateActionHandlerFactory
    {
        ...
        public CorporateActionHandlerFactory(IPortfolioQuery portfolioQuery, Obsolete.StockService stockService, Obsolete.IncomeService incomeService)
        {
            ...
            _HandlerFactory.Register<Dividend>(() => new DividendHandler(_PortfolioQuery, _StockService, _IncomeService));
