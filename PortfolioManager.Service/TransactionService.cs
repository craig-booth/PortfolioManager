...
namespace PortfolioManager.Service
{
    ...
    public class TransactionService
    {
        ...
        internal TransactionService(IPortfolioDatabase portfolioDatabase, ParcelService parcelService, StockService stockService, AttachmentService attachmentService, PortfolioSettingsService portfolioSettingService)
        {
            ...
            _TransactionHandlers.Add(TransactionType.Income, new IncomeReceivedHandler(parcelService, stockService, portfolioSettingService));
