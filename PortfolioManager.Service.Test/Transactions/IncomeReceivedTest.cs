...
namespace PortfolioManager.Service.Test.Transactions
{
    ...
    public class IncomeReceivedTrustSingleParcelTaxDeferred : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, openingBalanceDate, GetStockId("CCC"), openingBalance.Units, 1.50m, openingBalance.CostBase, openingBalance.CostBase - 30.00m, Guid.Empty, ParcelEvent.CostBaseReduction));
            _ExpectedIncome.Add(IncomeFromTransacation(incomeReceived));
        }
    }
    ...
    public class IncomeReceivedTrustMultipleParcelsTaxDeferred : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
             ...
             * 
            */
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, openingBalanceDate1, GetStockId("CCC"), openingBalance1.Units, 1.50m, openingBalance1.CostBase, 1227.27m, Guid.Empty, ParcelEvent.CostBaseReduction));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, openingBalanceDate2, GetStockId("CCC"), openingBalance2.Units, 1.00m, openingBalance2.CostBase, 72.73m, Guid.Empty, ParcelEvent.CostBaseReduction));
            _ExpectedIncome.Add(IncomeFromTransacation(incomeReceived));
        }
    }
    ...
    public class IncomeReceviedChildTrustSingleParcelTaxDeferred : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, aquisitionDate, GetStockId("SSS3"), 1000, 9.00m, 9000.00m, 8700.00m, purchaseId, ParcelEvent.CostBaseReduction));
