...
namespace PortfolioManager.Service.Test.Transactions
{
    ...
    public class CostBaseAdjustmentOrdinaryShareSingleParcel : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, aquisitionDate, GetStockId("AAA"), 1000, 1.50m, 1500.00m, 450.00m, Guid.Empty, ParcelEvent.CostBaseReduction));
        }
    }
    ...
    public class CostBaseAdjustmentOrdinaryShareMultipleParcels : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, aquisitionDate1, GetStockId("AAA"), 1000, 1.50m, 1500.00m, 450.00m, Guid.Empty, ParcelEvent.CostBaseReduction));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, aquisitionDate2, GetStockId("AAA"), 500, 2.40m, 1200.00m, 360.00m, Guid.Empty, ParcelEvent.CostBaseReduction));                           
    ...
    { 
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateTimeConstants.NoEndDate, aquisitionDate, GetStockId("SSS3"), 1000, 9.00m, 9000.00m, 2700.00m, purchaseId, ParcelEvent.CostBaseReduction));
