...
namespace PortfolioManager.Service.Test.Transactions
{
    ...
    public class AquisitionOrdinaryShare : TransactionTestWithExpectedTests 
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, GetStockId("AAA"), aquisition.Units, aquisition.AveragePrice, costBase, costBase));
        }
    }
    ...
    public class AquisitionStapledSecurity : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, GetStockId("SSS1"), aquisition.Units, 1.00m, 1002.00m, 1002.00m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, GetStockId("SSS2"), aquisition.Units, 3.00m, 3005.98m, 3005.98m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, GetStockId("SSS3"), aquisition.Units, 6.00m, 6011.97m, 6011.97m, purchaseId));
        }
    }
