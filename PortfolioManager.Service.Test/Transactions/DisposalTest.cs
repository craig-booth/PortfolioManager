...
namespace PortfolioManager.Service.Test.Transactions
{
    ...
    public class DisposalOrdinaryShareSingleParcelSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("AAA"), 500, 1.50m, 750.00m, 750.00m, Guid.Empty));
    ...
    public class DisposalOrdinaryShareSingleParcelMultipleEffectiveDatesSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("AAA"), 500, 1.50m, 750.00m, 650.00m, Guid.Empty));
    ...
    public class DisposalOrdinaryShareMultipleParcelsSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate2, GetStockId("AAA"), 300, 2.40m, 720.00m, 720.00m, Guid.Empty));
    ...
    public class DisposalStapledSecuritySingleParcelSellAll : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
         ...
         /*   _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS1"), _TransactionDate, 1000, 1500.00m, 3398.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS2"), _TransactionDate, 1000, 4500.00m, 6796.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS3"), _TransactionDate, 1000, 9000.00m, 6796.00m)); */
        }
    }
    ...
    public class DisposalStapledSecuritySingleParcelSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS1"), 500, 1.50m, 750.00m, 750.00m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS2"), 500, 4.50m, 2250.00m, 2250.00m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS3"), 500, 9.00m, 4500.00m, 4500.00m, purchaseId));

            // Relative purchase NTA... s1 = 10% ,s2 = 30%, s3 = 60%
            // Relative sale NTA... s1 = 20% ,s2 = 40%, s3 = 40%
          /*  _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS1"), _TransactionDate, 500, 750.00m, 1698.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS2"), _TransactionDate, 500, 2250.00m, 3396.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS3"), _TransactionDate, 500, 4500.00m, 3396.00m)); */
        }
    }
    ...
    public class DisposalStapledSecuritySingleParcelMultipleEffectiveDatesSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS1"), 500, 1.50m, 750.00m, 750.00m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS2"), 500, 4.50m, 2250.00m, 2250.00m, purchaseId));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, DateUtils.NoEndDate, aquisitionDate, GetStockId("SSS3"), 500, 9.00m, 4500.00m, 4450.00m, purchaseId));

            // Relative purchase NTA... s1 = 10% ,s2 = 30%, s3 = 60%
            // Relative sale NTA... s1 = 20% ,s2 = 40%, s3 = 40%
        /*    _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS1"), _TransactionDate, 500, 750.00m, 1698.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS2"), _TransactionDate, 500, 2250.00m, 3396.00m));
            _ExpectedCGTEvents.Add(new CGTEvent(GetStockId("SSS3"), _TransactionDate, 500, 4450.00m, 3396.00m));
*/
            _ExpectedIncome.Add(IncomeFromTransacation(taxDeferredIncome));
        }
    }
