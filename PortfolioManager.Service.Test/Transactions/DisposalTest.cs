...
namespace PortfolioManager.Service.Test.Transactions
{
    ...
    public class DisposalOrdinaryShareSingleParcelSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, 500, 1.50m, 750.00m, 750.00m, ParcelEvent.Disposal)
                {
    ...
    public class DisposalOrdinaryShareSingleParcelMultipleEffectiveDatesSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, 500, 1.50m, 750.00m, 650.00m, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
    ...
    public class DisposalOrdinaryShareMultipleParcelsSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate2, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, 300, 2.40m, 720.00m, 720.00m, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
    ...
    public class DisposalStapledSecuritySingleParcelSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("SSS1", _TransactionDate).Id, 500, 1.50m, 750.00m, 750.00m, purchaseId, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("SSS2", _TransactionDate).Id, 500, 4.50m, 2250.00m, 2250.00m, purchaseId, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("SSS3", _TransactionDate).Id, 500, 9.00m, 4500.00m, 4500.00m, purchaseId, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
    ...
    public class DisposalStapledSecuritySingleParcelMultipleEffectiveDatesSellPart : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(aquisitionDate, _StockServiceRepository.StockService.GetStock("SSS3", _TransactionDate).Id, 500, 9.00m, 4500.00m, 4450.00m, purchaseId, ParcelEvent.Disposal)
            {
                FromDate = _TransactionDate
            });
