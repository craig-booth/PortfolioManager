...
namespace PortfolioManager.Model.Test.Portfolios.CorporateActionHandlers
{
    ...
    public class DividendHandlerTest : PortfolioTest
    {
        ...
        public void SingleParcelNoDRP()
        {
            ...
            var dividend = new Dividend(_StockDatabase, _StockManager.GetStock("AAA", recordDate).Id, recordDate, paymentDate, 0.50m, 0.50m, 0.300m, 0.00m, "Test");
        ...
        public void MultipleParcelsNoDRP()
        {
            ...
            var dividend = new Dividend(_StockDatabase, _StockManager.GetStock("AAA", recordDate).Id, recordDate, paymentDate, 0.50m, 0.80m, 0.30m, 0.00m, "Test");
        ...
        public void MultipleParcelsDRP()
        {
            ...
            var dividend = new Dividend(_StockDatabase, _StockManager.GetStock("AAA", recordDate).Id, recordDate, paymentDate, 0.50m, 1.00m, 0.30m, 20.00m, "Test");
        ...
        public void NoParcels()
        {
            ...
            var dividend = new Dividend(_StockDatabase, _StockManager.GetStock("AAA", recordDate).Id, recordDate, paymentDate, 0.50m, 0.50m, 0.30m, 0.00m, "Test");
