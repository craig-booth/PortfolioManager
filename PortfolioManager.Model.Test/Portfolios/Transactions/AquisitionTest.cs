...
namespace PortfolioManager.Model.Test.Portfolios.Transactions
{
    ...
    public class AquisitionOrdinaryShare : TransactionTestWithExpectedTests 
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, _StockManager.StockService.GetStock("AAA", _TransactionDate).Id, aquisition.Units, aquisition.AveragePrice, costBase, costBase, ParcelEvent.Aquisition));
        }
    }
    ...
    public class AquisitionStapledSecurity : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, _StockManager.StockService.GetStock("SSS1", _TransactionDate).Id, aquisition.Units, 1.00m, 1002.00m, 1002.00m, purchaseId, ParcelEvent.Aquisition));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, _StockManager.StockService.GetStock("SSS2", _TransactionDate).Id, aquisition.Units, 3.00m, 3005.98m, 3005.98m, purchaseId, ParcelEvent.Aquisition));
            _ExpectedParcels.Add(new ShareParcel(_TransactionDate, _StockManager.StockService.GetStock("SSS3", _TransactionDate).Id, aquisition.Units, 6.00m, 6011.97m, 6011.97m, purchaseId, ParcelEvent.Aquisition));
        }
    }
