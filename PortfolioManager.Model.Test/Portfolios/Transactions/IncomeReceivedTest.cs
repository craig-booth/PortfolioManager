...
namespace PortfolioManager.Model.Test.Portfolios.Transactions
{
    ...
    public class IncomeReceivedOrdinaryShareSingleParcel : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(openingBalanceDate, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, openingBalance.Units, 1.50m, openingBalance.CostBase, openingBalance.CostBase, ParcelEvent.OpeningBalance));
    ...
    public class IncomeReceivedOrdinaryShareMultipleParcels : TransactionTestWithExpectedTests
    {
        public override void PerformTest()
        {
            ...
            _ExpectedParcels.Add(new ShareParcel(openingBalanceDate1, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, openingBalance1.Units, 1.50m, openingBalance1.CostBase, openingBalance1.CostBase, ParcelEvent.OpeningBalance));
            _ExpectedParcels.Add(new ShareParcel(openingBalanceDate2, _StockServiceRepository.StockService.GetStock("AAA", _TransactionDate).Id, openingBalance2.Units, 1.60m, openingBalance2.CostBase, openingBalance2.CostBase, ParcelEvent.OpeningBalance));
            _ExpectedIncome.Add(new Income(incomeReceived));
        }
    }
